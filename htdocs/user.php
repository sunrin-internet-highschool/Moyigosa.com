    ...
    <div id="middle">
        <div id="signup_wrap">
            ...
            <form method="post" action="">
                ...
                <?php
                echo "<input type=\"text\" name=\"id\" value=\"",$_SESSION['id'],"\" class=\"id\"><br>";
                ?>
